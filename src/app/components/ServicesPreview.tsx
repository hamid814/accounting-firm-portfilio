...
export function ServicesPreview() {
  return (
    <section
      id="services"
      className="py-12 md:py-16 lg:py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-3 md:mb-4 text-gray-900 px-4">
            خدمات ما
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 md:mb-12">
          {services.map((service, index) => {
            ...
            const isAccentCard = [0, 2, 4].includes(index) === true;
            return (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                {/* Glassmorphism card */}
                <div
                  className={`relative p-5 sm:p-6 lg:p-8 rounded-2xl lg:rounded-3xl backdrop-blur-xl bg-white/80 border transition-all duration-500 h-full ${
                    isAccentCard
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 rounded-2xl lg:rounded-3xl bg-gradient-to-br opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${
                      isAccentCard
                  ...
                  {/* Glow effect */}
                  <div
                    className={`absolute -inset-0.5 rounded-2xl lg:rounded-3xl blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-500 ${
                      isAccentCard
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="relative inline-block mb-4 md:mb-6">
                      <div
                        className={`w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-gradient-to-br rounded-xl lg:rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-2xl transition-all duration-500 ${
                          isAccentCard
                    ...
                    <div className="flex items-start justify-between gap-2 mb-2 md:mb-3">
                      <h3
                        className={`text-lg sm:text-xl lg:text-2xl text-gray-900 transition-colors duration-300 ${
                          isAccentCard
                      ...
                      {/* Arrow icon */}
                      {/* <ArrowUpRight
                        className={`w-5 h-5 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:translate-x-[-4px] group-hover:translate-y-[-4px] ${
        ...
        >
          ...
          >
            ...
            <Sparkles
              size={16}
              className="relative z-10 sm:w-[18px] sm:h-[18px] group-hover:rotate-12 transition-transform duration-300"
            />
          </Link>
        </motion.div>
      </div>
